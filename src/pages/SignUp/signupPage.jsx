                ...
                <div className="input-area">
                    <form className="form-area">
                        <div>
                            ...
                            <input type="" id="Name" placeholder="Enter Your Name" className="email-input" />
                        </div>
                        <div>
                        ...
                        <div className="password-wrapper">
                            ...
                            <input type="password" id="ConfirmPass" placeholder="Enter Same Password" className="email-input" />
                        </div>
