                ...
                <div className="input-area">
                    <form className="form-area">
                        <div>
                            ...
                            <input type="email" id="Name" placeholder="Enter Your Name" class="email-input-field" />
                        </div>
                        <div>
                        ...
                        <div className="password-wrapper">
                            ...
                            <input type="password" id="ConfirmPass" placeholder="Enter Same Password" class="email-input-field" />
                        </div>
